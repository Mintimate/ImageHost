...
<div style="padding: 15px; height: 100%">
    <table class="layui-table" lay-size="lg">
        ...
        color: transparent;" class="layui-btn layui-btn-disabled layui-btn-xs"><span>每页<span
                ...
                <button ImageType="壁纸" id="first" class="layui-btn layui-btn-primary layui-btn-xs ">首页</button>
                <button ImageType="壁纸" id="last" class="layui-btn layui-btn-primary layui-btn-xs">尾页</button>
                <button class="layui-btn-disabled layui-btn-xs"><span id="currentPage">${currentPage }</span>/<span id="pages">${pages }</span></button>
                <button ImageType="壁纸" id="previous" class="layui-btn layui-btn-primary layui-btn-xs">上一页</button>
                <button ImageType="壁纸" id="next" class="layui-btn layui-btn-primary layui-btn-xs">下一页</button>
