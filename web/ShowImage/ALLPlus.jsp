    ...
    <table class="layui-table" lay-size="lg">
        ...
        <c:forEach items="${list}" var="public_image">
            <tr style="height: 10%">
                ...
                <td height="100px"><a onclick="do_download()"
                                      href="/DownloadImage?filename=${public_image.image_name}&id=${public_image.id}">
                    <span style="color: #F44336">Here</span>
                </a></td>
                <td height="100px"><a onclick="do_view()" target="_blank"
                                      href="/image?method=view&id=${public_image.id}">
        ...
        color: transparent;" class="layui-btn layui-btn-disabled layui-btn-xs"><span>每页<span
                ...
                <button ImageType="null" id="first" class="layui-btn layui-btn-primary layui-btn-xs ">首页</button>
                <button ImageType="null" id="last" class="layui-btn layui-btn-primary layui-btn-xs">尾页</button>
                <button class="layui-btn-disabled layui-btn-xs"><span id="currentPage">${currentPage }</span>/<span
                        id="pages">${pages }</span></button>
                <button ImageType="null" id="previous" class="layui-btn layui-btn-primary layui-btn-xs">上一页</button>
                <button ImageType="null" id="next" class="layui-btn layui-btn-primary layui-btn-xs">下一页</button>
                <button class="layui-btn layui-btn-normal layui-btn-xs" href="#" onclick="do_flash()">刷新下载&浏览</button>
            </td>
        </tr>
        </tbody>
    </table>
